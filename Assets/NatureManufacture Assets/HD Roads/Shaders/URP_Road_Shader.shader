	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 tex2DNode537 = tex2D( _TextureSample3, uv0_TextureSample3 );
				...
				float3 tex2DNode4 = UnpackNormalScale( tex2D( _BumpMap, uv0_MainTex ), _BumpScale );
				...
				float3 tex2DNode535 = UnpackNormalScale( tex2D( _SecondRoadNormal, uv0_TextureSample3 ), _SecondRoadNormalScale );
				...
				float4 tex2DNode2 = tex2D( _MetalicRAmbientOcclusionGHeightBEmissionA, uv0_MainTex );
				float4 tex2DNode536 = tex2D( _SecondRoadMetallicRAmbientocclusionGHeightBSmoothnessA, uv0_TextureSample3 );
				...
				float3 Albedo = lerpResult592.rgb;
